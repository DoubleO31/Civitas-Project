    ...
    if (this.state.selectedFile) {
      ...
      fetch('/upload', {
        ...
        if (parsedData.imageUrl) {
          this.setState({photoURL: parsedData.imageUrl, long: longitude, lat: latitude});
      ...
      <div style={modalStyle}>
        ...
        <form onSubmit={this.uploadHandler}>
          ...
          <div>
            <input ref={(ref) => {
                this.fileTitle = ref;
              }} type="text" placeholder="Enter the desired title of file"/>
          </div>
          <div>
            <input ref={(ref) => {
                this.fileDesc = ref;
              }} type="text" placeholder="Enter the desired description of file"/>
          </div>
          <button>Upload!</button>
        </form>
        <div>
          <button onClick={this._closeUploadWindow}>Close
          </button>
        </div >
      </div>
    </div >);
